...
**Plans**: 5 plans
  - [ ] 01-01-PLAN.md — Drizzle schema + Neon DB provision + schema push (BLOCKING)
  - [ ] 01-02-PLAN.md — Env skeleton (.env.example) + runtime env validator (lib/env.ts)
  - [ ] 01-03-PLAN.md — iron-session v8 + /login page + /api/auth/{login,logout}
