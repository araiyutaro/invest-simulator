...
**Plans**: 4 plans
  - [x] 04-01-PLAN.md — ダークテーマ・ライブラリインストール・1306.Tホワイトリスト・ページシェル
  - [x] 04-02-PLAN.md — データレイヤーTDD（型定義・metrics計算・DBクエリ）
  - [x] 04-03-PLAN.md — チャート・指標グリッド・ポジションテーブル・配分パイチャート
  - [x] 04-04-PLAN.md — トレードタイムライン・追加読み込みAPI
**UI hint**: yes
...
**Plans**: 6 plans
  - [x] 05-01-PLAN.md — vercel.json 作成 + daily-run/route.ts に GET ハンドラ追加 (Pitfall 1 修正、OPS-01/02 CRITICAL)
  - [x] 05-02-PLAN.md — next.config.ts に6種のセキュリティヘッダ (HSTS/CSP/XFO/XCTO/RP/PP) を配線 (OPS-03)
  - [x] 05-03-PLAN.md — proxy.ts matcher 強化 + .env.example 監査 (OPS-03)
  - [x] 05-04-PLAN.md — 05-SECURITY-CHECKLIST.md 作成 (D-13 §1-§7 再利用可能テンプレート)
  - [x] 05-05-PLAN.md — 05-ROLLOUT.md 作成 (D-15 7 ステップ初回デプロイ手順) + ユーザー checkpoint
  - [x] 05-06-PLAN.md — 本番デプロイ実行 + SECURITY-CHECKLIST 実行 + 05-VERIFICATION.md サインオフ
